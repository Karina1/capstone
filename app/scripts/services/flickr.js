 ...
 */
 angular.module('capstoneApp')
   .factory('flickr', function ($resource) {
     ...
     // Public API here
     return $resource('https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=f90b0fdc1b04e6c99b933cddf84d6560&tags=pedestrian+zone,pedestrian+bridge-portrait,footbridge,pedestrian+precinct&extras=geo,tags,url_m,owner_name&format=json&nojsoncallback=1', {}, {
